...
sT[0].sCP[0].sCPR[169].nDCStart=865;     sT[0].sCP[0].sCPR[169].nDCNum= 74;   sT[0].sCP[0].sCPR[169].nSCStart=939;    sT[0].sCP[0].sCPR[169].nAckStart=0;	  sT[0].sCP[0].sCPR[169].nAckNum=0;   sT[0].sCP[0].sCPR[169].nSPOffsetCS=3867;  sT[0].sCP[0].sCPR[169].nSPOffsetLek=3868;
...
sT[0].sTI[119].nType = TYP_MOT;
	...
	sT[0].sMOT[119].nIEC_SP				= 2542;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[119].nIEC_SP_NUM			= 20;		/* Egybites értékek száma*/
	sT[0].sMOT[119].nIEC_DP				= 741;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[119].nIEC_DP_NUM			=8;   		/* Két bites értékek száma*/
	sT[0].sMOT[119].nIEC_NM				= 752;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[119].nNMNum				= 9;		/* Analóg mérések száma*/

/* Kömlõd 099/14,16,17  ----------------------------------------------------------------*/
sT[0].sTI[120].nType = TYP_MOT;

	sT[0].sMOT[120].nIEC_SP				= 2564;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[120].nIEC_SP_NUM			= 26;		/* Egybites értékek száma*/
	sT[0].sMOT[120].nIEC_DP				= 750;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[120].nIEC_DP_NUM			=16;   		/* Két bites értékek száma*/
	sT[0].sMOT[120].nIEC_NM				= 761;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[120].nNMNum				= 18;		/* Analóg mérések száma*/

/* Vönöck 064/25   ----------------------------------------------------------------*/
sT[0].sTI[121].nType = TYP_MOT;

	sT[0].sMOT[121].nIEC_SP				= 2592;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[121].nIEC_SP_NUM			= 26;		/* Egybites értékek száma*/
	sT[0].sMOT[121].nIEC_DP				= 766;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[121].nIEC_DP_NUM			=16;   		/* Két bites értékek száma*/
...
sT[0].sTI[122].nType = TYP_MOT;
	...
	sT[0].sMOT[122].nIEC_SP_NUM			= 18;		/* Egybites értékek száma*/
	sT[0].sMOT[122].nIEC_DP				= 782;		/* Kétbites értékek IEC kezdõcíme*/
...
sT[0].sTI[123].nType = TYP_MOT;
	...
	sT[0].sMOT[123].nIEC_SP_NUM			= 18;		/* Egybites értékek száma*/
	sT[0].sMOT[123].nIEC_DP				= 790;		/* Kétbites értékek IEC kezdõcíme*/
...
sT[0].sTI[129].nType = TYP_MOT;
	...
	sT[0].sMOT[129].nIEC_SP				= 2828;		/* Egybites értékek IEC kezdõcíme*/
...
sT[0].sTI[138].nType = TYP_MOT;
	...
	sT[0].sMOT[138].nIEC_SP				= 3097;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[138].nIEC_SP_NUM			= 16;		/* Egybites értékek száma*/
	sT[0].sMOT[138].nIEC_DP				= 886;		/* Kétbites értékek IEC kezdõcíme*/
...
/* Sótony 089/14 PV erõmû  ----------------------------------------------------------------*/
sT[0].sTI[141].nType = TYP_MOT;

	sT[0].sMOT[141].nIEC_SP				= 3185;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[141].nIEC_SP_NUM			= 16;		/* Egybites értékek száma*/
	sT[0].sMOT[141].nIEC_DP				= 942;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[141].nIEC_DP_NUM			= 8;   		/* Két bites értékek száma*/
	sT[0].sMOT[141].nIEC_NM				= 956;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[141].nNMNum				= 9;		/* Analóg mérések száma*/

/* Sótony 089/15 PV erõmû  ----------------------------------------------------------------*/
sT[0].sTI[142].nType = TYP_MOT;

	sT[0].sMOT[142].nIEC_SP				= 3203;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[142].nIEC_SP_NUM			= 16;		/* Egybites értékek száma*/
	sT[0].sMOT[142].nIEC_DP				= 950;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[142].nIEC_DP_NUM			= 8;   		/* Két bites értékek száma*/
	sT[0].sMOT[142].nIEC_NM				= 965;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[142].nNMNum				= 9;		/* Analóg mérések száma*/

/* 15-07  -----------------------------------------------------------*/	
  sT[0].sTI[143].nType = TYP_TMOK;

	sT[0].sMOT[143].nIEC_SP				= 3221;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[143].nIEC_DP				= 958;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[143].nIEC_NM				= 974;		/* Mérések IEC kezdõcíme */	

/* Bocfölde 0109 KÁ1 PV erõmû  ----------------------------------------------------------------*/
sT[0].sTI[144].nType = TYP_MOT;

	sT[0].sMOT[144].nIEC_SP				= 3237;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[144].nIEC_SP_NUM			= 16;		/* Egybites értékek száma*/
	sT[0].sMOT[144].nIEC_DP				= 959;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[144].nIEC_DP_NUM			=22;   		/* Két bites értékek száma*/
	sT[0].sMOT[144].nIEC_NM				= 0;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[144].nNMNum				= 0;		/* Analóg mérések száma*/

/* Bocfölde 0109 KÁ2 PV erõmû  ----------------------------------------------------------------*/
sT[0].sTI[145].nType = TYP_MOT;

	sT[0].sMOT[145].nIEC_SP				= 3255;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[145].nIEC_SP_NUM			= 16;		/* Egybites értékek száma*/
	sT[0].sMOT[145].nIEC_DP				= 981;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[145].nIEC_DP_NUM			=18;   		/* Két bites értékek száma*/
	sT[0].sMOT[145].nIEC_NM				= 0;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[145].nNMNum				= 0;		/* Analóg mérések száma*/

/* Bocfölde 0109 KÁ3 PV erõmû  ----------------------------------------------------------------*/
sT[0].sTI[146].nType = TYP_MOT;

	sT[0].sMOT[146].nIEC_SP				= 3273;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[146].nIEC_SP_NUM			= 18;		/* Egybites értékek száma*/
	sT[0].sMOT[146].nIEC_DP				= 999;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[146].nIEC_DP_NUM			=34;   		/* Két bites értékek száma*/
	sT[0].sMOT[146].nIEC_NM				= 977;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[146].nNMNum				= 17;		/* Analóg mérések száma*/

/* Bocfölde 0109 KÁ4 PV erõmû  ----------------------------------------------------------------*/
sT[0].sTI[147].nType = TYP_MOT;

	sT[0].sMOT[147].nIEC_SP				= 3293;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[147].nIEC_SP_NUM			= 16;		/* Egybites értékek száma*/
	sT[0].sMOT[147].nIEC_DP				=1033;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[147].nIEC_DP_NUM			=24;   		/* Két bites értékek száma*/
	sT[0].sMOT[147].nIEC_NM				= 0;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[147].nNMNum				= 0;		/* Analóg mérések száma*/

/* Ikervár 0404/14,16,18,20 PV erõmû  ----------------------------------------------------------------*/
sT[0].sTI[148].nType = TYP_MOT;

	sT[0].sMOT[148].nIEC_SP				= 3311;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[148].nIEC_SP_NUM			= 30;		/* Egybites értékek száma*/
	sT[0].sMOT[148].nIEC_DP				=1057;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[148].nIEC_DP_NUM			=18;   		/* Két bites értékek száma*/
	sT[0].sMOT[148].nIEC_NM				= 994;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[148].nNMNum				= 23;

/* Mosonmagyaróvár, Kápolna tér  ----------------------------------------------------------------*/
sT[0].sTI[149].nType = TYP_MOT;

	sT[0].sMOT[149].nIEC_SP				= 1350;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[149].nIEC_SP_NUM			= 20;		/* Egybites értékek száma*/
	sT[0].sMOT[149].nIEC_DP				=326;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[149].nIEC_DP_NUM			=10;   		/* Két bites értékek száma*/
	sT[0].sMOT[149].nIEC_NM				= 350;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[149].nNMNum				= 12;

/* Mosonmagyaróvár, Kühne Ede  ----------------------------------------------------------------*/
sT[0].sTI[150].nType = TYP_MOT;

	sT[0].sMOT[150].nIEC_SP				= 1384;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[150].nIEC_SP_NUM			= 32;		/* Egybites értékek száma*/
	sT[0].sMOT[150].nIEC_DP				=336;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[150].nIEC_DP_NUM			=12;   		/* Két bites értékek száma*/
	sT[0].sMOT[150].nIEC_NM				= 1017;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[150].nNMNum				= 15;

/* Dudar 075/9 PV erõmû  ----------------------------------------------------------------*/
sT[0].sTI[151].nType = TYP_MOT;

	sT[0].sMOT[151].nIEC_SP				= 3343;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[151].nIEC_SP_NUM		= 16;		/* Egybites értékek száma*/
	sT[0].sMOT[151].nIEC_DP				= 1075;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[151].nIEC_DP_NUM		= 4;   		/* Két bites értékek száma*/
	sT[0].sMOT[151].nIEC_NM				= 1032;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[151].nNMNum				= 9;

  /* Bük, Golf utca,  TALUS 8 csatornas !!! ----------------------------------------------*/
...
sT[0].sTI[157].nType = TYP_MOT;
	...
	sT[0].sMOT[157].nIEC_SP				= 3510;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[157].nIEC_SP_NUM		= 16;		/* Egybites értékek száma*/
	sT[0].sMOT[157].nIEC_DP				= 1128;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[157].nIEC_DP_NUM		= 4;   		/* Két bites értékek száma*/
	sT[0].sMOT[157].nIEC_NM				= 1083;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[157].nNMNum				= 9;

/* Kincsesbánya 03100/3  ----------------------------------------------------------------*/
sT[0].sTI[158].nType = TYP_MOT;

	sT[0].sMOT[158].nIEC_SP				= 3528;		/* Egybites értékek IEC kezdõcíme*/
  ...
  /* Királyszentistván 017/35 PV erõmû ----------------------------------------------------------------*/
  ...
  /* Királyszentistván 017/36 PV erõmû ----------------------------------------------------------------*/
...
/* 30-75  -----------------------------------------------------------*/	
  sT[0].sTI[165].nType = TYP_TMOK;
	...
	sT[0].sMOT[165].nIEC_SP				= 3725;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[165].nIEC_DP				= 1173;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[165].nIEC_NM				= 1141;		/* Mérések IEC kezdõcíme */	

/* Lukácsháza 0107/4  ----------------------------------------------------------------*/
sT[0].sTI[166].nType = TYP_MOT;

	sT[0].sMOT[166].nIEC_SP				= 3741;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[166].nIEC_SP_NUM		= 24;		/* Egybites értékek száma*/
	sT[0].sMOT[166].nIEC_DP				= 1174;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[166].nIEC_DP_NUM		= 10;   		/* Két bites értékek száma*/
